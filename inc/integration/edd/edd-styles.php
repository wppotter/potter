...
function potter_do_edd_customizer_css() {
	...
	if ( 'hide' !== $edd_menu_item_desktop ) {
		...
		if ( $edd_menu_item_desktop_color ) {
			...
			echo '.potter-menu .potter-edd-menu-item .potter-edd-menu-item-count {';
	...
	if ( 'hide' !== $edd_menu_item_mobile ) {
		...
		if ( $edd_menu_item_mobile_color ) {
			...
			echo '.potter-mobile-nav-wrapper .potter-edd-menu-item .potter-edd-menu-item-count {';
...
add_action( 'potter_after_customizer_css', 'potter_do_edd_customizer_css', 10 );
