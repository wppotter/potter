! function(b) {
  ...
  b(".full-screen-search .potter-close").click(function() {
    c()
  });
...
jQuery(document).ready(function() {
  ...
  //jQuery(".full-screen-search .potter-close").click(function() {
    //jQuery(".full-screen-search").css("display", "none");
    //jQuery(".potter-menu-item-search").removeClass("active");
  //});
